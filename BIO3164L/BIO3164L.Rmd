...
\myjpg{consommables}{1}{\color{rouge}Les consommables utilisés pour les expériences, de gauche à droite : du coton hydrophile en bande prédécoupé, la variété \textbf{V1} et la variété \textbf{V2} de lentilles. Voir la \refs{conso} pour une description détaillée.}
...
\myjpg{export}{0.5}{\color{rouge}Les options utilisées lors de l'exportation du fichier \texttt{lentille.ods} au format CSV.}
...
\lettrine{P}{our} la production de plants de lentilles on aura intérêt à utiliser des graines de la variété \textbf{V1} semées à l'obscurité.
\color{bleu}
